...
void redraw_screen() {
  ...
  for (int i = 0; i < num_fields; i++) {
    ...
    minifont_draw_str(vram_s + (640 * textpos_y) + (textpos_x + (60 * i)), 640, buf);
  }
  textpos_y += 20;
  textpos_x = 10;
  ...
  textpos_y += 16;
  minifont_draw_str(vram_s + (640 * textpos_y) + textpos_x, 640, "Press Start to quit.");
